...
class TranslationDataset(Dataset):
    def __init__(self, df, vocab_transform):
        """
        df: pandas DataFrame với các cột 'en_tok' và 'vi_tok' chứa list token (hoặc list str)
...
# ===================== CREATE DATALOADERS =====================
def create_dataloaders(batch_size, num_workers=0, val_frac=0.1, test_frac=0.1, shuffle_train=True):
    """
